internal class Program
{
    ...
    {
        // Criar uma variavel
        // Sintaxe: tipo variavel nome_variável = valor_variavel

        // Tipo de dados Primarios
        /* int -> Representa-ção dos números inteiros 
        */
        int idade = 21;
        ...
        DateTime cadastro = new DateTime(2026,08,04,09,15,32); // (2026-08-04 09:15:32)
