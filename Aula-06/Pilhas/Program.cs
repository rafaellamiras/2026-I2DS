internal class Program
{
    private static void Main(string[] args)
    {
        ...
        pilhasLivros.Push("DO Morro dos Ventos Uivantes");
        pilhasLivros.Push("O Cortiço");

        // 3- Percorrer todos os elemntos de uma pilha
        Console.WriteLine();
        ...
        string livroRemovido = pilhasLivros.Pop(); // POP remove o primeiro elemento da fila
        Console.WriteLine();
